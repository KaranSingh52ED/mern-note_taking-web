...
const Faq = () => {
  ...
  return (
    <div className="lg:h-heightWithoutNavbar divide-y rounded-lg m-5 ring-2 ring-red-500 shadow-2xl bg-gradient-to-br from-red-400 to-gray-100  shadow-blue-500  grid place-content-center">
