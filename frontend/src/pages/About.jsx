...
const About = () => {
  return (
    <div className="h-heightWithoutNavbar flex m-5 flex-col items-center divide-y rounded-lg  ring-2 ring-red-500 shadow-xl bg-gradient-to-br from-red-400 to-gray-100  shadow-emerald-300 justify-start p-5 lg:flex-row">
